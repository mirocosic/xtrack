      ...
      <FlingGestureHandler
        ...
        <FlingGestureHandler
          ...
          <Animated.View style={styles.formFieldWrap}>
            ...
            <TouchableOpacity onPress={() => setType("expense")} style={[styles.transactionTypeButton]}>
              <View style={styles.typeWrap}>
                <Copy style={{ color: "white" }}>EXPENSE</Copy>
              </View>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => setType("income")} style={[styles.transactionTypeButton]}>
              <View style={styles.typeWrap}>
                <Copy style={{ color: "white" }}>INCOME</Copy>
              </View>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => setType("transfer")} style={[styles.transactionTypeButton]}>
              <View style={styles.typeWrap}>
