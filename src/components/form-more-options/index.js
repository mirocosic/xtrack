...
export default props => {
  ...
  const { toggleRecuring, transaction, selectSchedule, submitForm, deleteTransaction, closeMoreOptions, onRemoveLabel, labelsModalRef, recurringCalendarModalRef } = props
  ...
  return (
    <View>
      ...
      <View style={styles.formFieldWrap}>
        <TouchableOpacity style={{ backgroundColor: "teal", padding: 5, paddingLeft: 10, paddingRight: 10, borderRadius: 20 }} onPress={() => labelsModalRef.current.open()}>
      ...
      <TouchableOpacity hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }} style={{ alignItems: "center", margin: 20 }} onPress={closeMoreOptions}>
        <CopyBlue>Less Options</CopyBlue>
      </TouchableOpacity>

      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <BorderlessButton onPress={deleteTransaction}>
          <Icon type="trash-alt" style={{ marginRight: 10 }} textStyle={{ color: darkMode ? palette.light : palette.dark }} />
        </BorderlessButton>
