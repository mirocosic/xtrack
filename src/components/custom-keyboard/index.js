...
export default ({ handlePress, setAmount, handleSubmit, del, navigation }) => {
    ...
    <View style={[styles.wrap, useDarkTheme() && styles.wrapDark]}>
      ...
      <View style={{ flexDirection: "row" }}>
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.row}>
            <Digit digit="<" handlePress={() => navigation.goBack()} isBackButton={true} icon="chevron-down" />
        ...
        <View>
          ...
          <RectButton style={[styles.digit, !calculationMode && { backgroundColor: palette.blue }]} onPress={() => (calculationMode ? calculate() : handleSubmit())}>
